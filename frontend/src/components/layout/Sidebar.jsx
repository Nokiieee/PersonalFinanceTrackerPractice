...
export default function Sidebar() {
  ...
  return (
    <>
      <aside className="hidden md:flex md:w-20 lg:w-64 flex-col shrink-0 bg-slate-900 border-r border-slate-800/80 transition-all duration-300 ease-in-out">
        {/* Brand */}
        ...
        <div className="px-3 lg:px-4 py-4 border-t border-slate-800/80 space-y-1">
          ...
          <button
            onClick={open}
            className="group flex items-center gap-3 w-full rounded-xl px-2.5 lg:px-3 py-2.5
                       text-slate-400 hover:bg-rose-500/10 hover:text-rose-400 transition-colors duration-150"
            title="Logout"
          >
          ...
          <div className="hidden lg:flex items-center gap-2.5 mt-2 px-2.5 py-2 rounded-xl bg-slate-800/60">
            <div className="h-8 w-8 rounded-full bg-gradient-to-br from-emerald-400 to-teal-500 flex items-center justify-center text-[12px] font-semibold text-slate-950 shrink-0">
              {initials}
            </div>
